...
public class ConfigHandler {
    ...
    public final static String SOURCE_MYSQL_URL = "jdbc:mysql://" + SOURCE_MYSQL_HOST + ":3306/" + SOURCE_MYSQL_DATABASE_NAME + "?useSSL=false";
    ...
    public final static String TARGET_MYSQL_URL = "jdbc:mysql://" + TARGET_MYSQL_HOST + ":3306/" + TARGET_MYSQL_DATABASE_NAME + "?useSSL=false";
